...
# HTML dan CSS dalam satu string
HTML_STRING = '''
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        body {
            ...
            background-image: url('https://example.com/background.jpg'); /* Ganti dengan URL gambar latar belakang yang diinginkan */
        ...
        .content {
            text-align: center;
            padding: 100px;
            background: rgba(0, 0, 0, 0.5); /* Tambahkan latar belakang semi-transparan untuk konten */
            border-radius: 8px;
        }
    </style>
</head>
<body>
    <div class="content">
        <h1>Selamat Datang di Aplikasi Estetis!</h1>
        <p>Ini adalah contoh aplikasi dengan latar belakang yang estetis.</p>
    </div>
</body>
</html>
'''
